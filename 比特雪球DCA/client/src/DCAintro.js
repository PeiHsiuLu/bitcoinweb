  ...
  return (
    <div>
      ...
      <div className="DCA-average">
        ...
        <ul>
        <li>降低市場投資風險：DCA允許投資者定期投資，不論市價如何變動，投資者都會在市場投入相同的價格，有助於降低市場波動對投資結果的影響。</li>
        <li>操作簡單：只要定期投入資金，無需太多複雜技術、知識。</li>
        <li>適合多數族群：定投與其他投資策略相比，所需的投資技術較低，不需要特別預測市場的高點或低點，大大降低錯誤決策的可能性。</li>
        <li>幫助建立長期投資策略：DCA鼓勵投資者建立規律的投資習慣，無須過度思考市場的市價變化。即便中途有虧損，虧損量也會比一次投入來得少。另外，因為不需要持續盯盤，讓人更容易繼續持有、按照策略執行。</li>
        <li>受歡迎的退休儲蓄方式：各種退休儲蓄計劃經常使用DCA，因為它是一種有效的長期投資策略。</li>
        </ul>
        <h2>DCA的計算公式</h2>
      ...
      {/* 滾動按鈕，觸發 scrollToDCAIntroduction */}
      <button onClick={scrollToDCAIntroduction}>滾動到DCA平均成本法介紹</button>
    </div>
  );
}
