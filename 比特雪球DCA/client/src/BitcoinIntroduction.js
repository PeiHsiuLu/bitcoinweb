...
function MyComponent() {
    ...
    return (
        <div>
            ...
            <br />
            <ul>
              <li>知名度和市場佔有率： 比特幣是第一個成功實施區塊鏈技術的加密貨幣，因此在市場上享有廣泛知名度和信任。</li>
              <li>去中心化和安全性： 比特幣採用去中心化的區塊鏈技術，無需中央機構控制，從而提高了安全性和透明度。</li>
              <li>可編程性和開放性： 比特幣是開放源碼的，允許開發者基於其區塊鏈構建各種解決方案和應用。</li>
              <li>流動性和接受度： 比特幣在全球范圍內都被廣泛接受，許多交易平臺和商家接受比特幣作為支付方式。</li>
              <li>有限供應： 比特幣的供應是有限的，最大供應量為2100萬枚，這意味著不會無限制地增加，有助於維持其價值。</li>
            </ul>
            <br />
            ...
            <button onClick={scrollToBitcoinIntro}>滾動到比特幣介紹</button>
        </div>
    );
}
